...
public class ConvertExchangeRateActivity extends Activity implements OnClickListener,OnMenuItemClickListener{
    ...
    public void initView(){
        ...
        choose_one = findViewById(R.id.choose_one);
        choose_two = findViewById(R.id.choose_two);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.double_zero:
                ...
                if (flag == 1) {
                    try {
                        ...
                        result_second.setText(con.CalExchangeRate(sour_name,value,tar_name));
                    }catch (Exception e){
                        Toast.makeText(this,"获取联网数据失败",Toast.LENGTH_SHORT).show();
                    }
                } else {
                   ...
                   try {
                       ...
                       Convert con = new Convert();
                       result_first.setText(con.CalExchangeRate(sour_name,value,tar_name));
                   } catch(Exception e){
                       Toast.makeText(this,"获取联网数据失败",Toast.LENGTH_SHORT).show();
                   }
                }
            ...
            case R.id.btn_main_choose:
                //跳转到计算器页面
                Intent intent = new Intent(ConvertExchangeRateActivity.this, MainActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.convert_base:
                Intent intent_base = new Intent(ConvertExchangeRateActivity.this, ConvertBaseActivity.class);
                startActivity(intent_base);
                break;
            case R.id.convert_length:
                Intent intent_len = new Intent(ConvertExchangeRateActivity.this, ConvertLengthActivity.class);
                startActivity(intent_len);
                break;
            case R.id.convert_area:
                Intent intent_area = new Intent(ConvertExchangeRateActivity.this, ConvertAreaActivity.class);
                startActivity(intent_area);
                break;
            case R.id.convert_speed:
                Intent intent_speed = new Intent(ConvertExchangeRateActivity.this, ConvertSpeedActivity.class);
                startActivity(intent_speed);
                break;
            case R.id.convert_temperature:
                Intent intent_tem = new Intent(ConvertExchangeRateActivity.this, ConvertTemperatureActivity.class);
                startActivity(intent_tem);
                break;
            case R.id.convert_weight:
                Intent intent_wei = new Intent(ConvertExchangeRateActivity.this, ConvertWeightActivity.class);
                startActivity(intent_wei);
                break;
            case R.id.convert_power:
                Intent intent_power= new Intent(ConvertExchangeRateActivity.this, ConvertPowerActivity.class);
                startActivity(intent_power);
                break;
            case R.id.convert_pressure:
                Intent intent_pressure = new Intent(ConvertExchangeRateActivity.this, ConvertPressureActivity.class);
                startActivity(intent_pressure);
                break;
            case R.id.convert_volume:
                Intent intent_volume = new Intent(ConvertExchangeRateActivity.this, ConvertVolumeActivity.class);
    ...
    private void setDialog() {
        ...
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.bottom_dialog_exchange_rate, null);
        ...
        root.findViewById(R.id.btn_JPY).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_KRW).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_GBP).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_CNY).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_ZWL).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_RUB).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_AUD).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_HUD).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_TWD).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_INR).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
