...
import com.example.calculator.Main.Convert.*;
...
public class ConvertAreaActivity extends Activity implements OnClickListener,OnMenuItemClickListener{
    //标识
    private int flag = 1;
        ...
        switch (view.getId()) {
            ...
            case R.id.double_zero:
                ...
                if (flag == 1) {
                    ...
                    result_second.setText(con.CalArea(sour_name,value,tar_name));
                } else {
                    ...
                    Convert con = new Convert();
                    result_first.setText(con.CalArea(sour_name,value,tar_name));
                }
                break;
            ...
            case R.id.btn_main_choose:
                //跳转到计算器页面
                Intent intent = new Intent(ConvertAreaActivity.this, MainActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.convert_exchange_rate:
                Intent intent_ex_ra = new Intent(ConvertAreaActivity.this, ConvertExchangeRateActivity.class);
                startActivity(intent_ex_ra);
                break;
            case R.id.convert_base:
                Intent intent_base = new Intent(ConvertAreaActivity.this, ConvertBaseActivity.class);
                startActivity(intent_base);
                break;
            case R.id.convert_length:
                Intent intent_length = new Intent(ConvertAreaActivity.this, ConvertLengthActivity.class);
            ...
            case R.id.convert_speed:
                Intent intent_speed = new Intent(ConvertAreaActivity.this, ConvertSpeedActivity.class);
                startActivity(intent_speed);
                break;
            case R.id.convert_temperature:
                Intent intent_tem = new Intent(ConvertAreaActivity.this, ConvertTemperatureActivity.class);
                startActivity(intent_tem);
                break;
            case R.id.convert_weight:
                Intent intent_wei = new Intent(ConvertAreaActivity.this, ConvertWeightActivity.class);
                startActivity(intent_wei);
                break;
            case R.id.convert_power:
                Intent intent_power= new Intent(ConvertAreaActivity.this, ConvertPowerActivity.class);
                startActivity(intent_power);
                break;
            case R.id.convert_pressure:
                Intent intent_pressure = new Intent(ConvertAreaActivity.this, ConvertPressureActivity.class);
                startActivity(intent_pressure);
                break;
            case R.id.convert_volume:
                Intent intent_volume = new Intent(ConvertAreaActivity.this, ConvertVolumeActivity.class);
    ...
    private void setDialog() {
        ...
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.bottom_dialog_area, null);

        //初始化视图
        root.findViewById(R.id.btn_m2).setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        root.findViewById(R.id.btn_km2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_dm2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_cm2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_mm2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_a).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_ha).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_ft2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_mi2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_mu).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_qing).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
