...
public class ConvertPowerActivity extends Activity implements OnClickListener,OnMenuItemClickListener{
    //标识
    private int flag = 1;
        ...
        switch (view.getId()) {
            ...
            case R.id.double_zero:
                ...
                if (flag == 1) {
                    ...
                    result_second.setText(con.CalPower(sour_name,value,tar_name));
                } else {
                    ...
                    Convert con = new Convert();
                    result_first.setText(con.CalPower(sour_name,value,tar_name));
                }
                break;
            ...
            case R.id.btn_main_choose:
                //跳转到计算器页面
                Intent intent = new Intent(ConvertPowerActivity.this, MainActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.convert_exchange_rate:
                Intent intent_ex_ra = new Intent(ConvertPowerActivity.this, ConvertExchangeRateActivity.class);
                startActivity(intent_ex_ra);
                break;
            case R.id.convert_base:
                Intent intent_base = new Intent(ConvertPowerActivity.this, ConvertBaseActivity.class);
                startActivity(intent_base);
                break;
            case R.id.convert_length:
                Intent intent_length = new Intent(ConvertPowerActivity.this, ConvertLengthActivity.class);
                startActivity(intent_length);
                break;
            case R.id.convert_area:
                Intent intent_area = new Intent(ConvertPowerActivity.this, ConvertAreaActivity.class);
                startActivity(intent_area);
                break;
            case R.id.convert_speed:
                Intent intent_speed = new Intent(ConvertPowerActivity.this, ConvertSpeedActivity.class);
                startActivity(intent_speed);
                break;
            case R.id.convert_temperature:
                Intent intent_tem = new Intent(ConvertPowerActivity.this, ConvertTemperatureActivity.class);
                startActivity(intent_tem);
                break;
            case R.id.convert_weight:
                Intent intent_wei = new Intent(ConvertPowerActivity.this, ConvertWeightActivity.class);
            ...
            case R.id.convert_pressure:
                Intent intent_pressure = new Intent(ConvertPowerActivity.this, ConvertPressureActivity.class);
                startActivity(intent_pressure);
                break;
            case R.id.convert_volume:
                Intent intent_volume = new Intent(ConvertPowerActivity.this, ConvertVolumeActivity.class);
    ...
    private void setDialog() {
        ...
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.bottom_dialog_power, null);

        //初始化视图
        root.findViewById(R.id.btn_Jps).setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        root.findViewById(R.id.btn_W).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_Nmps).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_kW).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
