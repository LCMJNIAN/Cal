...
public class ConvertVolumeActivity extends Activity implements OnClickListener,OnMenuItemClickListener{
    //标识
    private int flag = 1;
        ...
        switch (view.getId()) {
            ...
            case R.id.double_zero:
                ...
                if (flag == 1) {
                    ...
                    result_second.setText(con.CalVolume(sour_name,value,tar_name));
                } else {
                    ...
                    Convert con = new Convert();
                    result_first.setText(con.CalVolume(sour_name,value,tar_name));
                }
                break;
            ...
            case R.id.btn_main_choose:
                //跳转到计算器页面
                Intent intent = new Intent(ConvertVolumeActivity.this, MainActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.convert_exchange_rate:
                Intent intent_ex_ra = new Intent(ConvertVolumeActivity.this, ConvertExchangeRateActivity.class);
                startActivity(intent_ex_ra);
                break;
            case R.id.convert_base:
                Intent intent_base = new Intent(ConvertVolumeActivity.this, ConvertBaseActivity.class);
                startActivity(intent_base);
                break;
            case R.id.convert_length:
                Intent intent_length = new Intent(ConvertVolumeActivity.this, ConvertLengthActivity.class);
                startActivity(intent_length);
                break;
            case R.id.convert_area:
                Intent intent_area = new Intent(ConvertVolumeActivity.this, ConvertAreaActivity.class);
                startActivity(intent_area);
                break;
            case R.id.convert_speed:
                Intent intent_speed = new Intent(ConvertVolumeActivity.this, ConvertSpeedActivity.class);
                startActivity(intent_speed);
                break;
            case R.id.convert_temperature:
                Intent intent_tem = new Intent(ConvertVolumeActivity.this, ConvertTemperatureActivity.class);
                startActivity(intent_tem);
                break;
            case R.id.convert_weight:
                Intent intent_wei = new Intent(ConvertVolumeActivity.this, ConvertWeightActivity.class);
                startActivity(intent_wei);
                break;
            case R.id.convert_power:
                Intent intent_power= new Intent(ConvertVolumeActivity.this, ConvertPowerActivity.class);
                startActivity(intent_power);
                break;
            case R.id.convert_pressure:
                Intent intent_pressure= new Intent(ConvertVolumeActivity.this, ConvertPressureActivity.class);
    ...
    private void setDialog() {
        ...
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.bottom_dialog_volume, null);

        //初始化视图
        root.findViewById(R.id.btn_m3).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        root.findViewById(R.id.btn_cm3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_dm3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_l).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_mm3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
        ...
        root.findViewById(R.id.btn_ml).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                if (choose_length == 1)
